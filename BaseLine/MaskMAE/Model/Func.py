...
def combine_graph_dict(dict_1, dict_2):
    tmp_adj_norm = torch.block_diag(dict_1['adj_norm'].to_dense(), dict_2['adj_norm'].to_dense()).to_sparse()
    tmp_adj_label = torch.block_diag(dict_1['adj_label'].to_dense(), dict_2['adj_label'].to_dense()).to_sparse()
    graph_dict = {
        "adj_norm": tmp_adj_norm,
        "adj_label": tmp_adj_label,
        "norm_value": np.mean([dict_1['norm_value'], dict_2['norm_value']])
